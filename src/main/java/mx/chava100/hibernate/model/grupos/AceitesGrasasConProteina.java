...
@Entity
@Table(name = "aceites_grasas_con_proteina")
public class AceitesGrasasConProteina implements Serializable {
    ...
    private AceitesGrasasConProteina(){
    ...
    public String toString() {
        return "AceitesGrasasConProteina{" +
                "id=" + id +
                ", cantidad='" + cantidad + '\'' +
